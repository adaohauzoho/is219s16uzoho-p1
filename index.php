    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Adaoha Uzoho</a>
            </div>
    ...
    <section id="team" class="bg-light-gray">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">About Me</h2>
                    <h3 class="section-subheading text-muted">Senior, Web & Information Systems, B.S</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="img/adaoha.jpg" class="img-responsive img-circle" alt="">
                        <h4>Adaoha Uzoho</h4>
...
If you like my work, or would like to get in touch with me, please fill out the form on the Contact Me page, or directly send me an email at adu2@njit.edu. </p>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <span class="copyright">Copyright &copy; Adaoha's Website 2016</span>
                </div>
                <div class="col-md-4">
                    <ul class="list-inline social-buttons">
                        <li><a href="https://www.facebook.com/adaohauzoho"><i class="fa fa-facebook"></i></a>
